...
export const ASSET_CATALOGUE = [
  ...
  { id: 'cylinder', label: 'Barrel',     category: ASSET_CATEGORY.DEFAULT, color: 0x3a5a3a, yOffset: 0.5, footprintW: 1, footprintH: 1, clip: true, height: 1.0 },
  ...
  { id: 'destructible_barrel', label: 'Destructible Barrel', category: ASSET_CATEGORY.DESTRUCTIBLE, color: 0x3a5a3a, yOffset: 0.5, footprintW: 1, footprintH: 1, clip: true, height: 1.0, destructible: true, baseAssetId: 'cylinder' },
