...
const PRESET_SETTINGS = [
  { key: 'g42', label: 'G42', path: './presets/g42.json', data: {
  "cameraMode": "third2",
  "isoCamD": 12,
  "thirdDist": 5,
  "thirdHeight": 3,
  ...
  "thirdPitch": -0.12679999999999805,
